...
const CSidebar = () => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 h-full bg-[#2B3A33] shadow-lg flex flex-col font-spaceGrotesk transform transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
